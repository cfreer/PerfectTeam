      ...
      it('it should GET the score and luxury tax of the given team with salary cap of 112400000', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
                  ...
                  res.body.score.should.be.eql(1.2673193554478226 - 0.5);
      ...
      it('it should GET the score and luxury tax of the given team with salary cap of 1000000', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
                  res.should.have.status(200);
                  res.body.should.be.a('Object');
                  res.body.score.should.be.eql(1.4033800709184585- 0.5);
      ...
      it('it should not include salary for 492', (done) => {
        chai.request(server)
            ...
            .end((err, res) => {
                  res.should.have.status(200);
                  res.body.should.be.a('Object');
                  res.body.score.should.be.eql(1.11150629272840780 - 0.5);
